...
class HotelBooking(models.Model):
    ...
    hotel_address = models.CharField(max_length=300, blank=True, null=True)
    # room_type = models.CharField(max_length=50, blank=True, null=True)
    # room_rate = models.FloatField(blank=True, null=True)
    num_of_guests = models.PositiveIntegerField(blank=True, null=True)
    booking_date = models.DateTimeField(default=datetime.now)
    mobile = models.CharField(max_length=20, blank=True)
    email = models.EmailField(max_length=45, blank=True)
    status = models.CharField(max_length=45, choices=TICKET_STATUS)
